...
class StopSignDetector():
	...
	def get_bounding_box(self, img):
		...
		for cont in contours:
			...
			if len(approx) >= 8 and cv2.contourArea(cont) >= 200: #For each approximated region, if the number of points larger than 8 and the area larger than 200 pixels, then a stop sign is detected.
